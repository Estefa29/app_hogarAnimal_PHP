           ...
           <?php foreach($animales as $animal):?>
                    ...
                    <div class="col mb-4">
                        <div class="card h-100">
                            ...
                            <div class="card-body">
                            <h3 class="card-title"><?php echo($animal["nombre"])?></h3>
                            <h5 class="card-title"><?php echo($animal["edad"])?></h5>
                            <h5 class="card-title"><?php echo($animal["alimento"])?></h5>
                            <p class="card-text"><?php echo($animal["descripcion"])?></p>
